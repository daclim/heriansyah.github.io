...
<body>
  <h1>Data Siswa</h1><hr>
  <a href="<?php echo base_url("welcome/form"); ?>">Import Data</a><br><br>
  <a href="<?php echo base_url('welcome/ex') ?>">export</a>
  ...
  if( ! empty($produk)){ // Jika data pada database tidak sama dengan empty (alias ada datanya)
    foreach($produk as $data){ // Lakukan looping pada variabel siswa dari controller
       echo "<tr>";
